...
const smilAnimationChart: ChartType = {
    data: {
...
const lineSmoothingChart: ChartType = {
    data: {
        labels: [1, 2, 3, 4, 5],
        series: [
            [1, 5, 10, 0, 1],
...
export {
smilAnimationChart, simpleLineChart, lineScatter, areaLineChart, lineSmoothingChart, overlappingBarChart,
